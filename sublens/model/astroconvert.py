...
def nfw_params500(cosmo, z, m500c, c500c, mlog10=True, *args, **kwargs):
    """
    ...
    r500 = (3. / 4. * m500c / (500. * cdens) / math.pi) ** (1. / 3.)
    rs = r500 / c500c
    dc = 500. / 3. * (c500c ** 3.) /\
         (math.log(1. + c500c) - c500c / (1. + c500c))
    rho_s = dc * cdens
...
def nfw_params(cosmo, z, m200c, c200c, mlog10=True, *args, **kwargs):
    """
    Calculates the parameters of an NFW halo based on the given cosmo
